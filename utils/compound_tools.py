...
class CompoundKit(object):
    ...
    bond_vocab_dict = {
        "bond_dir": rdchem_enum_to_list(rdchem.BondDir.values),  # For chirality, https://www.rdkit.org/docs/cppapi/classRDKit_1_1Bond.html
...
class CompoundSeqKit:
    ...
    def encode_single_smiles(smiles: str, max_len: int):
        ...
        if smiles == "C1=Cc2ccc[siH]c2C1":
            smiles = "C1=Cc2ccc[SiH]c2C1"
    ...
    def encode_multi_smiles(smiles_list: str, max_len: int):
        ...
        for i, smiles in enumerate(tqdm(smiles_list)):
            ...
            seq_feat_list.append((seq_feat, lens, smiles))
